...
<?php endif; ?>
	...
	<div class="wp-filter">	
		...
		<p class="howto"><b> <?php echo __("Replace the file, use new file name and update links"); ?></b> — <?php echo __("If you select this option, the name and type of the file you upload will replace the old file. All links in Post Content pointing to the current file (", "enable-media-replace"); ?><?php echo $current_filename; ?><?php echo __(") will be updated to point to the new file name. Please note that only embeds/links to the original size image will be replaced in your posts.", "enable-media-replace"); ?></p>
